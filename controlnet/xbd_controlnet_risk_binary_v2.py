#!/usr/bin/env python3
"""
xbd_controlnet_risk_binary_v2.py
...
4) Keeps the original binary severity mechanism, but also supports different
   prompts for post and identity branches.
5) Saves both ControlNet weights and UNet LoRA weights for sampling.
...
def train(args):
    ...
    while state.global_step < args.max_train_steps:
        ...
        if args.lambda_l1 > 0.0 or args.lambda_lpips > 0.0:
