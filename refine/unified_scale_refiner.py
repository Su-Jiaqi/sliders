...
def build_datasets(cfg: TrainConfig):
    ...
    train_ds = UnifiedScaleRefinerDataset(
        stems=train_pairs,
        pre_map=pre_map,
        post_map=post_map,
    ...
    val_ds = UnifiedScaleRefinerDataset(
        stems=val_pairs,
        pre_map=pre_map,
        post_map=post_map,
        scale_maps=scale_maps,
...
def build_parser():
    parser = argparse.ArgumentParser("Unified scale-conditioned refiner")
    ...
    p_refine.add_argument("--scale_value", type=float, default=None, help="Optional. If omitted, parsed from input_dir basename like scale0.5")
