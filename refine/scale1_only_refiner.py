...
class TrainConfig:
    ...
    lpips_backbone: str = "alex"  # alex / vgg / squeeze
...
class Scale1ToPostDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x = torch.cat([gen, pre], dim=0)  # 6 channels
        return {
            "x": x,
            "gen": gen,
            "pre": pre,
...
def build_parser():
    parser = argparse.ArgumentParser("Scale1 -> post refiner with stronger residual + LPIPS")
